...
// ═══ WORK STACK — same animation as services ═══
const WORK_TOP = 90;
...
function animateWork() {
  ...
  cards.forEach((card, i) => {
    ...
    if (below > 0) {
      ...
      const nextTop = tops[i + 1];
      if (nextTop !== undefined) {
        const covered = (WORK_TOP + heights[i]) - nextTop;
        if (covered > 0) {
          const t = Math.min(covered / heights[i], 1);
          scale = 1 - t * 0.08;
          sy    = 1 - t * 0.06;
...
window.addEventListener('scroll', () => {
  if (!rafPending2) {
    rafPending2 = true;
    requestAnimationFrame(() => { animateWork(); rafPending2 = false; });
  }
}, { passive: true });
window.addEventListener('resize', animateWork);
animateWork();
...
const projects = {
  ...
  'visual-identity':{ name: 'Kotryna Creates',                year: '2025', cat: 'Brand Identity',   images: ['images/visual-identity/cover.png','images/visual-identity/1.png','images/visual-identity/2.png','images/visual-identity/3.png','images/visual-identity/4.png','images/visual-identity/5.png','images/visual-identity/6.png','images/visual-identity/7.png','images/visual-identity/8.png','images/visual-identity/9.png'], desc: 'Personal logo and visual identity system.' },
  jaunimo:          { name: 'Jaunimo linija',                  year: '2022', cat: 'Book Design',        images: ['images/jaunimo/cover.png','images/jaunimo/1.png','images/jaunimo/2.png','images/jaunimo/3.png','images/jaunimo/4.png','images/jaunimo/5.png','images/jaunimo/6.png','images/jaunimo/7.png'], desc: 'Exercise book design.', layout: 'grid' },
  ...
  ekosanus:         { name: 'EKOsanus',                        year: '2021', cat: 'Brand Identity',     images: ['images/ekosanus/cover.png','images/ekosanus/1.jpg','images/ekosanus/1.png','images/ekosanus/2.png','images/ekosanus/3.png','images/ekosanus/4.png','images/ekosanus/5.png','images/ekosanus/6.png','images/ekosanus/7.png'], desc: "Logo and packaging for brewer's yeast." },
  orkla:            { name: 'Orkla care',                      year: '2024', cat: 'Advertising and digital', images: ['images/orkla/cover.png','images/orkla/1.png','images/orkla/2.png','images/orkla/3.png','images/orkla/5.jpg','images/orkla/6.png','images/orkla/7.png','images/orkla/8.png','images/orkla/9.jpg','images/orkla/10.png'], desc: '' },
  vom:              { name: 'VOM Baltics',                     year: '2022', cat: 'Advertising and digital', images: ['images/vom/cover.jpg','images/vom/1.jpg','images/vom/3.jpg','images/vom/4.jpg','images/vom/5.jpg','images/vom/6.jpg','images/vom/7.jpg','images/vom/8.jpg','images/vom/9.jpg','images/vom/10.jpg','images/vom/11.jpg','images/vom/12.jpg'], desc: '' },
